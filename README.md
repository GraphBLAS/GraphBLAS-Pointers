...
### Selected papers and documentation

* :star: Jeremy Kepner et al.: [Mathematical Foundations of the GraphBLAS](https://people.eecs.berkeley.edu/~aydin/GraphBLAS-Math.pdf), HPEC 2016
  * A more detailed version of this paper is part of the ["GraphBLAS Mathematics - Provisional Release 1.0"](http://www.mit.edu/~kepner/GraphBLAS/GraphBLAS-Math-release.pdf) specification document (2017)
  * An updated version of this paper is reprinted in the [Mathematics of Big Data](https://mitpress.mit.edu/books/mathematics-big-data) book (2018), see Chapter 6, p81-113.
* :gear: Aydın Buluç, Timothy G. Mattson, Scott McMillan, Jose Moreira, Carl Yang: The GraphBLAS C API Specification
...
* Timothy A. Davis: [Algorithm 1000: SuiteSparse:GraphBLAS: graph algorithms in the language of sparse linear algebra](http://faculty.cse.tamu.edu/davis/GraphBLAS_files/toms_graphblas.pdf), ACM Transactions on Mathematical Software (TOMS), 2019
...
* :star: John R. Gilbert's talks
  * [GraphBLAS: Graph Algorithms in the Language of Linear Algebra](https://sites.cs.ucsb.edu/~gilbert/talks/Gilbert-27Jun2019.pdf), June 2019
